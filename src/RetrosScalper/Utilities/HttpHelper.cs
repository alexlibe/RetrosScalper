...
namespace RetrosScalper.Utilities
{
    static class HttpHelper
    {
        ...
        public static async Task<HttpResponseMessage> GetBestBuyResponse(Uri url)
        {
        ...
        public static async Task<HttpResponseMessage> GetNeweggResponse(Uri url)
        {
            HttpResponseMessage response = null;
            Client.DefaultRequestHeaders.Clear();
            Client.DefaultRequestHeaders.Add("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8");
            ...
            Client.DefaultRequestHeaders.CacheControl = new CacheControlHeaderValue();
            Client.DefaultRequestHeaders.CacheControl.MaxAge = TimeSpan.Zero;
            Client.DefaultRequestHeaders.Host = "www.newegg.com";
